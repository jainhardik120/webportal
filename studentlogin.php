...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="margin-top:20px;">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="f1" action="studentLogin.php" onsubmit="return validation()" method="POST">
    ...
    if (isset($_POST["submit1"])) {
        ...
        $sql = "select *from student where eno = '$username' and code = '$password'";
        $result = mysqli_query($con, $sql);
        $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
        $count = mysqli_num_rows($result);
        if ($count == 1) {
            echo "<h1><center> Login successful </center></h1>";
            $_SESSION["eno"] = $_POST['user'];
